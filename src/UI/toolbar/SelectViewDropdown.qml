...
//                 implicitHeight: root._toolButtonHeight
//                 Layout.fillWidth: true
//                 text: qsTr("Standard View")
//                 imageResource: "/qmlimages/PaperPlane.svg"
//                 onClicked: {
//                     if (mainWindow.allowViewSwitch()) {
//                         mainWindow.closeIndicatorDrawer()
//                         mainWindow.dashboardMode = false
//                         mainWindow.focusedPanel = ""
//                         mainWindow.standardView = "fly"
//                         mainWindow.toolDrawer.visible = false
//                     }
//                 }
//             }
        ...
        GridLayout {
            ...
            SubMenuButton {
                ...
                onClicked: {
                    if (mainWindow.allowViewSwitch()) {
                        mainWindow.closeIndicatorDrawer()
                        mainWindow.showMissionConsoleView()
                    }
                }
            }
